...
function addRowToTable(description, value) {
    ...
    tableRows.forEach(row => {
        ...
        // Cria células com campos de entrada para edição
        let descriptionCell = tableRow.insertCell(0);
        let valueCell = tableRow.insertCell(1);
...
// Função para copiar a tabela para a área de transferência em formato HTML
function copyTableToClipboard() {
    ...
    // Cria uma nova área de transferência temporária para copiar o HTML
